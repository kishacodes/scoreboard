...
const $$AdminScoreboardDisplay = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="scoreboard-grid" id="admin-scoreboard" data-astro-cid-hl7zq6gi> ${games.map((game) => renderTemplate`<div class="game-card"${addAttribute(game.id, "data-game-id")} data-astro-cid-hl7zq6gi> <div class="game-header" data-astro-cid-hl7zq6gi> <span class="game-date" data-astro-cid-hl7zq6gi>${formatDate(game.gameDate)}</span> <span class="game-level" data-astro-cid-hl7zq6gi>${toTitleCase(game.teams)}</span> </div> <div class="game-body" data-astro-cid-hl7zq6gi> <div class="team" data-astro-cid-hl7zq6gi> <span class="team-name" data-astro-cid-hl7zq6gi>${game.ehs}</span> <input type="number" class="team-score-input"${addAttribute(game.ehsFinal, "value")} data-astro-cid-hl7zq6gi> </div> <div class="team" data-astro-cid-hl7zq6gi> <span class="team-name" data-astro-cid-hl7zq6gi>${game.opp}</span> <input type="number" class="team-score-input"${addAttribute(game.oppFinal, "value")} data-astro-cid-hl7zq6gi> </div> </div> <div class="game-update-section" data-astro-cid-hl7zq6gi> <div class="update-input-group" data-astro-cid-hl7zq6gi> <input type="text" class="update-text-input" placeholder="Add update note (optional)"${addAttribute(game.id, "data-game-id")} data-astro-cid-hl7zq6gi> <button class="update-button" data-astro-cid-hl7zq6gi>Update Score</button> </div> <div class="update-history"${addAttribute(`update-history-${game.id}`, "id")} data-astro-cid-hl7zq6gi></div> </div> </div>`)} </div>  `;
