const $=e=>{if(!e)return"";const a={year:"numeric",month:"long",day:"numeric",timeZone:"UTC"};return new Date(e).toLocaleDateString("en-US",a)},h=e=>e?e.charAt(0).toUpperCase()+e.slice(1).toLowerCase():"",g=document.body.dataset.page==="admin",w=e=>{if(g)return`
